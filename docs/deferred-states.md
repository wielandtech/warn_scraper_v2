...
| **PA** | `dli.pa.gov/Individuals/Workforce-Development/warn/notices/Pages/{Month}-{Year}.aspx` | Confirmed broken. Old DLI domain redirects to `pa.gov/agencies/dli`; monthly ASPX pages return 404. Searched `pa.gov` for a WARN notices replacement — no results. The `pa.gov/agencies/dli/.../warn-notices.html` page appears to not exist or be unpublished. | Re-check `pa.gov/agencies/dli` periodically for a WARN notices section to appear. May require a direct inquiry to PA DLI. |
